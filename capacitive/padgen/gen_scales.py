...
def main():
  parser = argparse.ArgumentParser(description="generate capacitive digital caliper scales")
  parser.add_argument("scale_length", help="Scale length in millimeters")
