prologue = """(module SLIDE_DRILL_RIGHT (layer F.Cu) (tedit {})
  (fp_text reference REF** (at 11.05 -0.05 90) (layer F.SilkS) hide
    (effects (font (size 1 1) (thickness 0.15)))
  )
  (fp_text value SLIDE_DRILL_RIGHT (at 0 -0.5) (layer F.Fab)
    (effects (font (size 1 1) (thickness 0.15)))
  )"""
...
print(pad.format(1, scale_right + 0.5*slide_drill_dia, 0, total_dia, total_dia, slide_drill_dia))
