...
prologue = """(module ANT_RX_0_45 (layer F.Cu)
  (at 0 0)
 (fp_text reference "G***" (at 0 0) (layer F.SilkS) hide
  (effects (font (thickness 0.3)))
  )
  (fp_text value "ANT_RX_0_45" (at 0.75 0) (layer F.SilkS) hide
  (effects (font (thickness 0.3)))
  )"""
...
start_x = 0 + perp_clearance*math.cos(math.pi/2 - alpha)
end_x = (end - start)*l/(2.0*math.pi) - perp_clearance*math.cos(math.pi/2 - beta)
